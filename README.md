...
В ходе работы мы также написали сайт, являющийся примером пользовательского интерфейса. Сайт работает независимо от данного кода, потому что расположен на бесплатном хостинге. 
https://bio-eq.vercel.app/

# Ссылка на материалы выступления

https://disk.yandex.ru/i/Ntyn4yYA0l45Tg

# BioEQ

`BioEQ` — Python-проект мультиагентной системы для синтетического планирования дизайна исследований биоэквивалентности и извлечения PK-параметров из научных публикаций.
